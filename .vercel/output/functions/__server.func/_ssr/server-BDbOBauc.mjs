...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-mYwLqFHq.mjs");
...
const manifest = {
  "0ad67c380016db25f7aa2ce898716aa017a10989a4755a1110da85c91e3031eb": {
    ...
    importer: () => import("./push.functions-CJds5AgW.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CKEh3UVe.mjs").then((n) => n.r),
    import("./start-DrlcVvWC.mjs"),
