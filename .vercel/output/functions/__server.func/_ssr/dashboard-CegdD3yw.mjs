...
function CheckInModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 bg-black/80 flex items-end sm:items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md rounded-sm border border-border bg-surface p-6 animate-slide-up", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-mono text-xs uppercase tracking-[0.3em] text-(--color-success) mb-3", children: [
      "[ DAY ",
      day,
      " — STAMP ]"
    ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            className: `w-full rounded-sm border bg-background px-3 py-2 text-sm font-mono uppercase tracking-widest transition disabled:opacity-50 ${pushEnabled ? "border-primary text-primary shadow-[0_0_14px_color-mix(in_srgb,var(--primary)_35%,transparent)]" : "border-border hover:bg-surface-2"}`,
            children: pushBusy ? "Connecting push..." : pushEnabled ? "Background push connected" : "Enable background push reminders"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
...
function Dashboard() {
  ...
  const syncChallengeReminderState = async (nextChallenge, notificationEnabled) => {
    const localUser = getLocalUser();
    if (!localUser) return;
  ...
  const fold = () => {
    ...
    void syncChallengeReminderState({
      ...challenge,
      status: "abandoned"
    }, false).catch((error) => {
